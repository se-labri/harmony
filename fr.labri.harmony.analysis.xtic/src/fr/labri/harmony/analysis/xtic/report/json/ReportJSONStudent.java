...
public class ReportJSONStudent extends Report {

	public ReportJSONStudent(String path) {
		super(path);
	}
	...
	public void printReport(List<Source> sources, Dao dao) {
		try {
			...
			for(Source src : sources) {
				...
				jGenerator.writeNumberField("first_commit", events.get(0).getTimestamp()); 
				jGenerator.writeNumberField("last_commit", events.get(events.size()-1).getTimestamp()); 
